...
import { getmedicines, getcategories, addmedicines, addcategory } from '../redux/actions/medicneAction';
...
export default connect(mapStatetoprops, { logoutseller, getsellerDetail, getmedicines, getcategories, addmedicines, addcategory })(Sellerhome)
